...
void HairModel::wet_init(Particle *p) {
	...
	Threshold º¯¼ö¸¦ »ı¼º,Threshold º¯¼ö´Â ¿øº» ÄÃ¿¡ ¿µÇâÀ» ¹Ş¾Æ 
...
void HairModel::pre_compute() {
	//rest Ã­Å’Å’Ã­â€¹Â°Ã­ÂÂ´ÃªÂ°â€Ã¬ÂËœ Ã­Ââ€°ÃªÂ·Â  ÃªÂ¸Â¸Ã¬ÂÂ´ ÃªÂ³â€Ã¬â€šÂ°
	...
	//smoothed Ã«ÂÅ“ rest Ã­Å’Å’Ã­â€¹Â°Ã­ÂÂ´ Ã¬Å“â€Ã¬Â¹Ëœ Ã¬Â â‚¬Ã¬Å¾Â¥
...
vector<vector<Vector3d>>  HairModel::smoothing_function(vector<vector<Vector3d>> lambda, vector<double> l,double alpha, bool is_position) {
	...
	//lambdaÃªÂ°â‚¬ Ã­Å’Å’Ã­â€¹Â°Ã­ÂÂ´ Ã¬Å“â€Ã¬Â¹ËœÃ¬ÂÂ¼ ÃªÂ²Â½Ã¬Å¡Â° returnÃ­â€¢ËœÃªÂ¸Â°Ã¬Å“â€Ã­â€¢Å“ pos vector
	resize(d, size);
	resize(pos, size);
	...
	for (int i = 0; i < lambda.size(); i++) {
		//beta formulation, l = Ã­Å’Å’Ã­â€¹Â°Ã­ÂÂ´ÃªÂ°â€Ã¬ÂËœ Ã­Ââ€°ÃªÂ·Â ÃªÂ¸Â¸Ã¬ÂÂ´
